...
If it would help to read the Foundation's general information or to reach a person for support, you can start here:

- Clinical care: {clinical_title} ({clinical_url})
- Contact the Foundation: {contact_title} ({contact_url})
